...
for module in features2d images vectorfields analysis featuredetection featurematching imagefilter imageprocessing  multispectral opticalflow vectorfieldprocessing racerclient registration winddetection
do
