...
print, sat
if (sat eq 'ERS1') then bildort=speiort+'/ERS1quicklook/'+noending+'_kl.png'
if (sat eq 'ERS2') then bildort=speiort+'/ERS2quicklook/'+noending+'_kl.png'
